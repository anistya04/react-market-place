    ...
    <section className="container mx-auto">
      <div className="flex flex-wrap my-4 md-my:12">
        <div className="w-full px-4 md:hidden">
          <h2 className="text-5xl font-semibold">Chair Thaty</h2>
          <span className="text-xl">IDR 1800000</span>
        </div>
        <div className="flex-1">
          <div className="slider">
            <div className="thumbnail">
              <div className="px-2 md:px-0">
                <div className="item" data-img="/images/content/chair-1.jpg">
                  <img
              ...
              <div className="px-2 md:px-0">
                <div className="item" data-img="/images/content/chair-2.jpg">
                  <img
              ...
              <div className="px-2 md:px-0">
                <div className="item" data-img="/images/content/chair-3.jpg">
                  <img
              ...
              <div className="px-2 md:px-0">
                <div className="item" data-img="/images/content/chair-4.jpg">
                  <img
              ...
              <div className="px-2 md:px-0">
                <div className="item" data-img="/images/content/chair-5.jpg">
                  <img
        ...
        <div className="flex-1 p-6">
          ...
          <Link
            to="/cart"
            className="inline-flex px-12 py-3 mt-4 text-black transition-all duration-200 bg-pink-300 rounded-full focus:text-pink-300 focus:bg-black"
          >
            <svg
