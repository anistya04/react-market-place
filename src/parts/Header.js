...
function Header(props) {
  ...
  return (
    <header className={`z-50 w-full px-4 ${position}`}>
      <div className="container mx-auto py-7">
        <div className="flex items-center ">
          <div className="flex items-center w-56">
            <img
              src="/images/design/logo.svg"
              alt="luxpace menjual toko furniture"
            />
          </div>
          <div className="w-full"></div>
          <div className="w-auto">
            <ul className="fixed inset-0 flex-col items-center justify-center invisible bg-white opacity-0 md:visible md:flex-row md:bg-transparent md:relative md:opacity-100 md:flex md:items-center">
          ...
          <div className="w-auto">
            <ul className="flex item-center">
              <li className="block ml-6 md:hidden">
                <button
                  id="menu-toggler"
                  className="relative z-50 flex items-center justify-center w-8 h-8 text-black md:text-white focus:outline-none hover:text-white"
                >
                  <svg
              ...
              <li className="ml-6">
                <Link
                  // id="header-cart"
                  to="/shopping"
                  className="flex items-center h-8 text-black v-8 hover:text-white cart cart-filled"
                >
                  <svg
                    className="fill-current"
                    width="29"
