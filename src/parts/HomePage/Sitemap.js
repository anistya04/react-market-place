...
export default function Sitemap() {
  return (
    <section className="">
      <div className="py-12 mt-16 border-t border-b border-gray-200 ">
        ...
        <aside className="container mx-auto">
          <div className="flex flex-wrap justify-center mx-4">
            <div className="w-full mb-4 md:mb-0 md:w-2/12 accordion">
            ...
            <div className="w-full mb-4 md:mb-0 md:w-3/12">
              <h5 className="mb-2 text-lg font-semibold">Special Letter</h5>
              <form action="#">
                <label for="" className="relative">
                  <input
                    type="text"
                    placeholder="Your Email Address"
                    className="w-full px-5 py-3 bg-gray-200 rounded-lg focus:outline-none"
                  />
                  <button
                    className="absolute right-0 p-3 bg-pink-300 rounded-lg"
                    type="submit"
                  >
                    <svg
                      width="24"
