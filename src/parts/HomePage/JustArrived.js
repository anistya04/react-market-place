  ...
  return (
    <section className="flex flex-col py-16">
      ...
      <div className="px-4 overflow-x-hidden" id="carousel">
        <div className="flex flex-row w-screen mx-4 overflow-x-auto">
          <div className="relative px-4 card group">
            <div
              className="relative overflow-hidden rounded-xl card-image"
              style={{ width: 287, height: 386 }}
            >
              <div className="absolute flex items-center justify-center w-full h-full transition duration-200 bg-black opacity-0 group-hover:opacity-100 bg-opacity-30">
              ...
              <img src="/images/content/image-carousel-4.jpg" alt="" />
            </div>
            <h5 className="mt-4 text-lg font-semibold">Buku Tulis</h5>
            <span>180.000</span>
            <Link to="/categories/123123" className="streched-link"></Link>
          </div>
          <div className="relative px-4 card group">
            <div
              className="relative overflow-hidden rounded-xl card-image"
            ...
            >
              ...
              <img src="/images/content/image-carousel-2.jpg" alt="" />
            </div>
            <h5 className="mt-4 text-lg font-semibold">Buku Tulis</h5>
            <span>180.000</span>
            <Link to="/categories/123123" className="streched-link"></Link>
          ...
          <div className="relative px-4 card group">
            ...
            >
              ...
              <img src="/images/content/image-carousel-1.jpg" alt="" />
            </div>
            <h5 className="mt-4 text-lg font-semibold">Buku Tulis</h5>
            <span>180.000</span>
            <Link to="/categories/123123" className="streched-link"></Link>
          ...
          <div className="relative px-4 card group">
            ...
            >
              ...
              <img src="/images/content/image-carousel-3.jpg" alt="" />
            </div>
            <h5 className="mt-4 text-lg font-semibold">Buku Tulis</h5>
            <span>180.000</span>
            <Link to="/categories/123123" className="streched-link"></Link>
